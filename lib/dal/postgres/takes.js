...
export class PostgresTakesRepository extends TakesRepository {
  async createLatestTake({ propID, propSide, phone, fields = {} }) {
    ...
    const { rows } = await query(
      `INSERT INTO takes (prop_id, prop_id_text, prop_side, take_mobile, take_status, pack_id)
       VALUES ($1, $2, $3, $4, 'latest', $5) RETURNING id`,
      [propUuid, propID, propSide, phone, packId]
    );
    return rows[0].id;
  }
